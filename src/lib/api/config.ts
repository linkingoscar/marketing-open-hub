...
export const API_PROVIDERS: APIProvider[] = [
  // 海外模型（按官方文档更新，2026-05-31）
  {
    ...
    pricing: { input: 2.0, output: 8.0, unit: "$/MTok" },
  },
  {
    id: "anthropic",
    ...
    pricing: { input: 5.0, output: 25.0, unit: "$/MTok" },
  },
  {
    id: "gemini",
    name: "Google Gemini",
    ...
    pricing: { input: 1.25, output: 10.0, unit: "$/MTok" },
  },
  // 国产模型（按官方文档更新，2026-05-31）
  {
    ...
    pricing: { input: 1.0, output: 3.0, unit: "$/MTok" },
  },
  {
    id: "deepseek",
    name: "DeepSeek (深度求索)",
    ...
    pricing: { input: 0.14, output: 0.28, unit: "$/MTok" },
  },
  {
    id: "qwen",
    name: "通义千问 (Qwen)",
    baseUrl: "https://dashscope.aliyuncs.com/compatible-mode/v1",
    models: ["qwen3.7-max", "qwen3.6-plus", "qwen3.6-flash", "qwen-plus", "qwen-turbo"],
    pricing: { input: 1.6, output: 6.4, unit: "¥/MTok" },
  },
  {
    id: "kimi",
    name: "Kimi (月之暗面)",
    ...
    pricing: { input: 6.0, output: 18.0, unit: "¥/MTok" },
  },
  {
    id: "doubao",
    name: "豆包 (字节跳动)",
    ...
    models: [
      ...
      "doubao-seed-2.0-lite-32k",
      "doubao-seed-2.0-mini-32k",
      "doubao-seed-2.0-code-32k",
    ],
  ...
  },
  {
    ...
    pricing: { input: 5.0, output: 10.0, unit: "¥/MTok" },
  },
  {
    id: "zhipu",
    name: "智谱 (GLM)",
    baseUrl: "https://open.bigmodel.cn/api/paas/v4",
    models: ["glm-5.1", "glm-4.7", "glm-4.7-flash", "glm-4-plus"],
    pricing: { input: 5.0, output: 5.0, unit: "¥/MTok" },
  },
