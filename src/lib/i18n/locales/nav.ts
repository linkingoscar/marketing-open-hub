...
export const navTranslations: Record<string, Record<string, string>> = {
  ...
  // Footer
  "footer.desc": {
    zh: "市场营销 × 消费者行为研究的开源项目发现平台。汇聚全球优质工具，助力数据驱动的营销决策。",
    en: "Open-source project discovery platform for marketing × consumer behavior research. Curating global tools for data-driven marketing decisions.",
  },
  ...
  "footer.copyright": {
    zh: "© 2026 MarTech Open Hub. All rights reserved.",
    en: "© 2026 MarTech Open Hub. All rights reserved.",
  },
