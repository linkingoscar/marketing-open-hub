 ...
 * 设置页面相关的翻译
 */
export const settingsTranslations: Record<string, Record<string, string>> = {
  "settings.title": { zh: "API 设置", en: "API Settings" },
  "settings.desc": {
    zh: "配置你的 API Key，即可在工作台中使用所有工具。密钥仅保存在浏览器本地，不会上传到任何服务器。",
    en: "Configure your API Key to use all tools in the workspace. Keys are stored locally in your browser only.",
  },
