...
export const workspaceTranslations: Record<string, Record<string, string>> = {
  ...
  "workspace.desc": {
    zh: "个开源项目的交互式工具，上传数据或输入内容直接开始分析",
    en: " interactive tools from open-source projects — upload data or input content to start analysis",
  },
  "workspace.api.configured": {
    zh: "API 已配置 — AI 工具可直接使用",
    en: "API configured — AI tools ready to use",
  },
  "workspace.api.missing": {
    zh: "未配置 API Key — 仅统计工具可用",
    en: "No API Key — only statistics tools available",
  },
  ...
  "guide.step1.desc": {
    zh: "清洗数据、处理缺失值、反向题编码",
    en: "Clean data, handle missing values, reverse-code items",
  },
  "guide.step2": { zh: "探索性分析", en: "Exploratory Analysis" },
  "guide.step2.desc": {
    zh: "描述性统计、分布检验、相关矩阵",
    en: "Descriptive stats, distribution tests, correlation matrix",
  },
  "guide.step3": { zh: "信效度检验", en: "Reliability & Validity" },
  "guide.step3.desc": {
    zh: "Cronbach's α、项目分析、EFA/CFA",
    en: "Cronbach's α, item analysis, EFA/CFA",
  },
  ...
  "guide.step6.desc": {
    zh: "APA 格式输出、图表导出、论文段落",
    en: "APA format output, chart export, paper paragraphs",
  },
};
