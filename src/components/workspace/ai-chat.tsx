...
const QUICK_ACTIONS = [
  {
    label: "解释这个统计结果",
    icon: BarChart3,
    prompt: "请用通俗易懂的语言解释以下统计结果的实际意义：",
  },
  {
    label: "推荐研究方法",
    icon: Lightbulb,
    prompt: "基于我的研究问题，请推荐合适的统计方法和分析流程：",
  },
  {
    label: "帮我写结果描述",
    icon: BookOpen,
    prompt: "请帮我将以下统计结果写成符合 APA 格式的结果描述段落：",
  },
    ...
    return (
      <div className={cn("glass-card p-8 text-center", className)}>
        ...
        <p className="text-xs text-[var(--text-muted)]">
          请先在设置页面配置 API Key，即可使用 AI 研究助手。
        </p>
      </div>
    );
  }
            ...
            >
              <div
                className={cn(
                  ...
                  msg.role === "user" ? "bg-[var(--primary)] text-white" : "glass-card"
                )}
              >
