          ...
          >
            ...
            {zone.value ? (
              <div className="flex items-center gap-1">
                ...
                <button
                  onClick={() => {
                    if (zone.key === "A") onChangeA("");
                    else if (zone.key === "B") onChangeB("");
                    else onChangeGroup("");
                  }}
        ...
        {expanded && (
          <div className="space-y-1 max-h-[200px] overflow-y-auto pr-1">
            ...
            {numericVars.length > 0 && (
              <div>
                <span className="text-[10px] text-[#3B82F6] mb-1 block">
                  连续变量 ({numericVars.length})
                </span>
            ...
            {catVars.length > 0 && (
              <div className="mt-2">
                <span className="text-[10px] text-[#F59E0B] mb-1 block">
                  分类变量 ({catVars.length})
                </span>
                <div className="flex flex-wrap gap-1.5">
                  {catVars.map((v) => (
