...
const STEPS = [
  {
    num: 1,
    title: "数据准备",
    desc: "清洗数据、处理缺失值、反向题编码",
    tool: "/workspace/data-clean",
    color: "#14B8A6",
  },
  {
    num: 2,
    title: "探索性分析",
    desc: "描述性统计、分布检验、相关矩阵",
    tool: "/workspace/statistics",
    color: "#A855F7",
  },
  {
    num: 3,
    title: "信效度检验",
    desc: "Cronbach's α、项目分析、EFA/CFA",
    tool: "/workspace/statistics",
    color: "#A855F7",
  },
  {
  ...
  },
  {
    num: 5,
    title: "因果建模",
    desc: "中介/调节效应、SEM、Uplift",
    tool: "/workspace/empirical",
    color: "#6366F1",
  },
  {
    num: 6,
    title: "结果导出",
    desc: "APA 格式输出、图表导出、论文段落",
    tool: "/workspace/statistics",
    color: "#A855F7",
  },
];
          ...
          {STEPS.map((step) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <span className="text-sm font-medium text-[var(--text-primary)] group-hover:text-[var(--primary-light)] transition-colors">
                  {step.title}
                </span>
