            ...
            {WORKFLOW_TEMPLATES.map((template, i) => (
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--primary)]">
                    {template.name}
                  </h4>
                </div>
                ...
                <div className="flex items-center gap-1.5 text-[10px] text-[var(--text-tertiary)]">
                  ...
                  <span>·</span>
                  <span>
                    {template.steps.filter((s) => s.type === "statistical-test").length} 项统计检验
                  </span>
                </div>
              </motion.button>
            ))}
                            ...
                            <div className="flex items-center gap-2 text-xs text-[var(--text-muted)]">
                              ...
                              {step.dependsOn.map((depId) => {
                                ...
                                return (
                                  <span
                                    key={depId}
                                    className="px-1.5 py-0.5 rounded bg-[var(--bg-card-hover)] text-[10px]"
                                  >
                                    {dep?.label ?? depId}
                                  </span>
                                );
