            ...
            >
              <span
                className={`w-8 h-8 rounded-lg flex items-center justify-center text-sm font-bold shrink-0 ${
                  index < 3
                    ? "bg-gradient-to-br from-[var(--warm)] to-[var(--primary)] text-white"
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-medium text-[var(--text-primary)] truncate group-hover:text-[var(--primary-light)] transition-colors">
                    {project.name}
                  </span>
