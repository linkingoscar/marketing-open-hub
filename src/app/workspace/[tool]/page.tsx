...
const defaultTools: ToolLink[] = [
  {
    ...
    title: "统计分析",
    desc: "36 种检验方法，自动生成 APA 结果段落",
  },
  {
    href: "/workspace/data-clean",
    title: "数据清洗",
    desc: "构念得分、反向题、缺失值、异常值与 CSV 导出",
  },
  {
    href: "/workspace/paper-writer",
    title: "论文写作辅助",
    desc: "把研究信息和统计结果转成学术段落",
  },
];
...
const categoryToolMap: Record<string, ToolLink[]> = {
  "ai-simulation": [
    {
      href: "/workspace/synthetic-research",
      title: "AI 模拟调研",
      desc: "生成虚拟样本、模拟访谈和市场反馈",
    },
    { href: "/workspace/sentiment", title: "情感分析", desc: "提取情绪、主题、购买意向与用户画像" },
    {
      href: "/workspace/paper-writer",
      title: "论文写作辅助",
      desc: "将模拟研究结果转成 APA 风格文本",
    },
  ],
  "sentiment-analysis": [
    {
      href: "/workspace/sentiment",
      title: "情感分析",
      desc: "支持情感、主题、用户画像、竞品和购买意向",
    },
    {
      href: "/workspace/brand-monitoring",
      title: "品牌监测",
      desc: "品牌可见性、舆情、竞品对比和危机预警",
    },
    {
      href: "/workspace/user-behavior",
      title: "用户行为分析",
      desc: "结合事件日志做漏斗、留存、RFM 与同期群",
    },
  ],
  "user-behavior": [
    {
      href: "/workspace/user-behavior",
      title: "用户行为分析",
      desc: "漏斗、留存、RFM、同期群与 AI 洞察",
    },
    { href: "/workspace/clv", title: "客户价值", desc: "RFM、CLV、流失风险和客户分群" },
    {
      href: "/workspace/data-clean",
      title: "数据清洗",
      desc: "先处理事件日志中的缺失、异常和字段问题",
    },
  ],
  "marketing-mix": [
    {
      href: "/workspace/causal",
      title: "因果推断",
      desc: "Uplift、DID、合成控制和 Granger 因果检验",
    },
    {
      href: "/workspace/timeseries",
      title: "时间序列",
      desc: "趋势分解、预测、异常检测和 AI 解读",
    },
    {
      href: "/workspace/bayesian",
      title: "贝叶斯分析面板",
      desc: "先验、后验、贝叶斯因子和敏感性分析",
    },
  ],
  "social-media": [
    ...
    {
      href: "/workspace/demand-validation",
      title: "需求验证",
      desc: "验证创意、PMF、市场规模和定价策略",
    },
  ],
  "brand-monitoring": [
    {
  ...
  "demand-validation": [
    {
      href: "/workspace/demand-validation",
      title: "需求验证",
      desc: "创意验证、PMF、市场规模和定价策略",
    },
    {
      href: "/workspace/synthetic-research",
      title: "AI 模拟调研",
      desc: "先用虚拟受访者快速探索需求假设",
    },
    {
      href: "/workspace/paper-writer",
      title: "论文写作辅助",
...
export default function ToolPage() {
  ...
  const suggestedTools = project
    ? (categoryToolMap[project.category] ?? defaultTools)
    : defaultTools;
        ...
        {project ? (
                    ...
                    .map((p) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-sm font-medium text-[var(--text-primary)] group-hover:text-[var(--primary-light)] transition-colors truncate">
                            {p.name}
                          </div>
          ...
          <div className="py-20">
            ...
            <p className="text-sm text-[var(--text-secondary)] mb-6">
              未匹配到专属项目，下面这些工具可以覆盖常见营销与消费者行为研究流程。
            </p>
