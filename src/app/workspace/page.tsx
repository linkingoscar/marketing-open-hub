    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-[var(--text-secondary)] mb-4">
          31 个开源项目与 18 个交互式工具，上传数据或输入内容直接开始分析
        </p>
        ...
        <div
          className={cn(
            ...
            hasAnyKey() ? "border-[var(--success)]/20" : "border-[var(--warning)]/20"
          )}
        >
          <div className="flex items-center gap-3">
            <Key
              className={cn(
                "w-5 h-5",
                hasAnyKey() ? "text-[var(--success)]" : "text-[var(--warning)]"
              )}
            />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
          ...
          >
            <div className="w-10 h-10 rounded-lg bg-[#F59E0B]/10 flex items-center justify-center text-xl shrink-0">
              📋
            </div>
            <div>
          ...
          <Link
            ...
            className="glass-card p-4 flex items-center gap-3 hover:border-[var(--primary)]/30 transition-all group"
          >
            <div className="w-10 h-10 rounded-lg bg-[#6366F1]/10 flex items-center justify-center text-xl shrink-0">
              🔄
            </div>
            <div>
              <h3 className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--primary)]">
          ...
          <Link
            href="/workspace/literature"
            className="glass-card p-4 flex items-center gap-3 hover:border-[var(--primary)]/30 transition-all group"
          >
            <div className="w-10 h-10 rounded-lg bg-[#10B981]/10 flex items-center justify-center text-xl shrink-0">
              📚
            </div>
            <div>
              <h3 className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--primary)]">
          ...
          <Link
            ...
            className="glass-card p-4 flex items-center gap-3 hover:border-[var(--primary)]/30 transition-all group"
          >
            <div className="w-10 h-10 rounded-lg bg-[#A855F7]/10 flex items-center justify-center text-xl shrink-0">
              🧮
            </div>
            <div>
              <h3 className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--primary)]">
          ...
          <div className="flex gap-2 overflow-x-auto pb-1">
            ...
            {categories.map((c) => (
              <button
                ...
                className={cn(
                  "shrink-0 px-3 py-1.5 rounded-full text-sm border transition-colors whitespace-nowrap",
                  selectedCat === c.id
                    ? "border-[var(--primary)] text-[var(--primary)] bg-[var(--primary)]/10"
                    : "border-[var(--border)] text-[var(--text-tertiary)]"
                )}
    ...
    <>
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="flex items-start justify-between mb-3">
          ...
          <Badge
            variant="outline"
            className="text-[10px] border-[var(--success)]/30 text-[var(--success)]"
          >
            可使用
          </Badge>
        </div>
