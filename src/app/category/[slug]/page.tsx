  ...
  return (
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <a
            ...
            className={cn(
              ...
              c.id === slug
                ...
                : "border-[var(--border)] text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:border-[var(--border-hover)]"
            )}
          >
            {c.icon} {c.nameCN}
          </a>
      ...
      {categoryProjects.length === 0 ? (
        ...
        <div
          className={cn(
            view === "grid" ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5" : "space-y-4"
          )}
        >
